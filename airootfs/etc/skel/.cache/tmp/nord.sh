...
apply() {
	...
	# Set the Nord profile as the default profile
	gsettings set "$GSETTINGS_PROFILELIST_PATH" default "$profile_uuid"
	log 4 "Set the Nord profile '$profile_name' as the default profile"
}

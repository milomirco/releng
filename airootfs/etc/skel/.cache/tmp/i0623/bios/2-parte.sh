...
su - $user -c "git clone https://github.com/ArchItalia/core-gtk-theme.git /home/$user/core-gtk-theme"
su - $user -c "git clone https://github.com/ArchItalia/architalia-fonts.git /home/$user/architalia-fonts"

# Construir e instalar los paquetes
su - $user -c "cd /home/$user/core-gtk-theme && makepkg -si --noconfirm && cd .."
su - $user -c "cd /home/$user/architalia-fonts && makepkg -si --noconfirm && cd .."
